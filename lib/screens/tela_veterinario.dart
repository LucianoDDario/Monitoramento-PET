...
import 'adiciona_veterinario.dart';
import 'package:projeto/models/pet.dart';

class TelaVeterinario extends StatelessWidget {
  final Pet pet;
  const TelaVeterinario({super.key, required this.pet});
          ...
          Expanded(
            child: Container(
              ...
              decoration: const BoxDecoration(
                color: Colors.white,
                border: Border(
                  top: BorderSide(color: cor, width: 10),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const _CardVeterinario(
                          nome: 'Dra Mariana',
                          cidade: 'Piracicaba',
                          bairro: 'Sta Terezinha',
                          rua: 'Manoel de Barros Ferraz 177',
                        ),
                        const SizedBox(height: 20),
                        Center(
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                       TelaAdicionarVeterinario(pet: pet),
                                ),
                              );
                            },
                            child: Container(
...
class _CardVeterinario extends StatelessWidget {
  final String nome;
  final String cidade;
  final String bairro;
  final String rua;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _CampoInfo(titulo: 'Nome (Clínica ou veterinário)', valor: nome),
          const SizedBox(height: 8),
          _CampoInfo(titulo: 'Cidade', valor: cidade),
          const SizedBox(height: 8),
          _CampoInfo(titulo: 'Bairro', valor: bairro),
          const SizedBox(height: 8),
          _CampoInfo(titulo: 'Rua', valor: rua),
          const SizedBox(height: 8),
          Row(
